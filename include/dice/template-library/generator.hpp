...
#ifdef DICE_TEMPLATELIBRARY_GENERATOR_STD_COMPAT
#define DICE_TEMPLATELIBRARY_GENERATOR_NAMESPACE std
#else
#define DICE_TEMPLATELIBRARY_GENERATOR_NAMESPACE dice::template_library
#endif // DICE_TEMPLATELIBRARY_GENERATOR_STD_COMPAT
...
namespace DICE_TEMPLATELIBRARY_GENERATOR_NAMESPACE {
    ...
    private:
        ...
        static void* _Allocate(_Alloc _Al, const size_t _Size) {
            if constexpr (::std::default_initializable<
                              _Alloc> && ::std::allocator_traits<_Alloc>::is_always_equal::value) {
    ...
    public:
        static void* operator new(const size_t _Size) requires ::std::default_initializable<_Alloc> {
        ...
        static void* operator new(
            const size_t _Size, ::std::allocator_arg_t, const _Alloc2& _Al, const _Args&...) {
            return _Allocate(static_cast<_Alloc>(static_cast<_Allocator>(_Al)), _Size);
        }

        template <class _This, class _Alloc2, class... _Args>
            requires ::std::convertible_to<const _Alloc2&, _Allocator>
        static void* operator new(const size_t _Size, const _This&, ::std::allocator_arg_t,
    ...
    public:
        ...
        static void* operator new(
            const size_t _Size, ::std::allocator_arg_t, const _Alloc& _Al, const _Args&...) {
            static_assert(
        ...
        static void* operator new(
            const size_t _Size, const _This&, ::std::allocator_arg_t, const _Alloc& _Al, const _Args&...) {
            static_assert(
                _Has_real_pointers<_Alloc>, "coroutine allocators must use true pointers");
            return _Allocate(_Al, _Size);
        }
    ...
    public:
        ...
        [[nodiscard]] auto yield_value(
            ::DICE_TEMPLATELIBRARY_GENERATOR_NAMESPACE::ranges::elements_of<generator<_Rty, _Vty, _Alloc>&&, _Unused> _Elem) noexcept {
            // clang-format on
        ...
        [[nodiscard]] auto yield_value(::DICE_TEMPLATELIBRARY_GENERATOR_NAMESPACE::ranges::elements_of<_Rng, _Alloc> _Elem) noexcept {
            // clang-format on
            using _Vty = ::std::ranges::range_value_t<_Rng>;
            return _Nested_awaitable<_Yielded, _Vty, _Alloc>{
                [](::std::allocator_arg_t, _Alloc, ::std::ranges::iterator_t<_Rng> _It,
                    const ::std::ranges::sentinel_t<_Rng> _Se)
                    -> generator<_Yielded, _Vty, _Alloc> {
                    for (; _It != _Se; ++_It) {
                        co_yield static_cast<_Yielded>(*_It);
                    }
                }(::std::allocator_arg, _Elem.allocator, ::std::ranges::begin(_Elem.range),
    ...
    private:
        struct _Element_awaiter {
            ...
            constexpr void await_suspend(::std::coroutine_handle<_Promise> _Handle) noexcept {
        ...
        struct _Final_awaiter {
            ...
            [[nodiscard]] ::std::coroutine_handle<> await_suspend(
                ::std::coroutine_handle<_Promise> _Handle) noexcept {
#ifdef __cpp_lib_is_pointer_interconvertible
                static_assert(::std::is_pointer_interconvertible_base_of_v<_Gen_promise_base, _Promise>);
#endif // __cpp_lib_is_pointer_interconvertible
        ...
        struct _Nested_awaitable {
            ...
            template <class _Promise>
            [[nodiscard]] ::std::coroutine_handle<_Gen_promise_base> await_suspend(
                ::std::coroutine_handle<_Promise> _Current) noexcept {
#ifdef __cpp_lib_is_pointer_interconvertible
                static_assert(::std::is_pointer_interconvertible_base_of_v<_Gen_promise_base, _Promise>);
#endif // __cpp_lib_is_pointer_interconvertible
                auto _Target =
                    ::std::coroutine_handle<_Gen_promise_base>::from_address(_Gen._Coro.address());
                _Nested._Parent =
                    ::std::coroutine_handle<_Gen_promise_base>::from_address(_Current.address());
    ...
    private:
        ...
        static_assert(::std::same_as<::std::remove_cvref_t<_Value>, _Value> && ::std::is_object_v<_Value>,
    ...
    public:
        struct EMPTY_BASES promise_type : _Promise_allocator<_Alloc>,
            ...
            [[nodiscard]] generator get_return_object() noexcept {
                return generator{
                    _Gen_secret_tag{}, ::std::coroutine_handle<promise_type>::from_promise(*this)};
            }
        };
        static_assert(::std::is_standard_layout_v<promise_type>);
#ifdef __cpp_lib_is_pointer_interconvertible
        static_assert(::std::is_pointer_interconvertible_base_of_v<_Gen_promise_base<_Gen_yield_t<_Ref>>,
            promise_type>);
#endif // __cpp_lib_is_pointer_interconvertible
...
#endif // DICE_TEMPLATELIBRARY_GENERATOR_HPP
