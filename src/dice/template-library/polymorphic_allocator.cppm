...
export module dice.template_library:polymorphic_allocator;
...
namespace dice::template_library {
	 ...
	 */
	export template<typename T, template<typename> typename ...Allocators>
	 ...
	 */
	export template<typename T, template<typename> typename Allocator = std::allocator>
