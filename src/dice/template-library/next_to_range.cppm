...
export module dice.template_library:next_to_range;
...
namespace dice::template_library {
	 ...
	 */
	export template<next_iterator Iter>
	 ...
	 */
	export template<next_back_iterator Iter>
	...
	*	 - nth(off) (optional):
	 ...
	 *		{ iter.remaining() } -> std::convertible_to<size_t>;
	 */
	export template<next_iterator Iter> requires (std::is_copy_constructible_v<Iter>)
