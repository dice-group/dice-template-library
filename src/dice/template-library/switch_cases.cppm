...
export module dice.template_library:switch_cases;
...
namespace dice::template_library {
   ...
   */
	export template<std::integral auto first, decltype(first) last, typename F, typename D>
	 ...
	 * @return The value returned from the switch case
	 */
	export template<std::integral auto first, decltype(first) last, typename F>
	 ...
	 * @return The value returned from the switch case
	 */
	export template<std::integral auto last, typename F, typename D>
	...
	* @return The value returned from the switch case
	 */
	export template<std::integral auto last, typename F>
