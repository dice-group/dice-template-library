...
export module dice.template_library:ranges;

export import :next_to_range;

namespace dice::template_library {
	DTL_DEFINE_SINGLE_FUNC_BASED_RANGE_ALGO(all_of, std::ranges::all_of, std::ranges::equal_to, export);
	DTL_DEFINE_SINGLE_FUNC_BASED_RANGE_ALGO(any_of, std::ranges::any_of, std::ranges::equal_to, export);
	DTL_DEFINE_SINGLE_FUNC_BASED_RANGE_ALGO(none_of, std::ranges::none_of, std::ranges::equal_to, export);
}// namespace dice::template_library
...
namespace dice::template_library {
     ...
     */
	export inline constexpr ranges_algo_detail::empty_fn empty{};
     ...
     */
	export inline constexpr ranges_algo_detail::non_empty_fn non_empty{};
...
namespace dice::template_library {
	 ...
	 */
	export [[deprecated("Use std::views::filter")]] inline constexpr ranges_algo_detail::remove_element_fn remove_element;
...
namespace dice::template_library {
     ...
     */
	DTL_DEFINE_SINGLE_FUNC_BASED_RANGE_ALGO(all_equal, ranges_algo_detail::all_equal_impl, std::ranges::equal_to, export);
}// namespace dice::template_library
...
namespace dice::template_library {
	 ...
	 */
    export [[deprecated("This view is inefficient and will be removed. Manually construct a set, or use a combination of chunk_by and transform "
...
namespace dice::template_library {
	 ...
	 */
    DTL_DEFINE_SINGLE_FUNC_BASED_RANGE_ALGO(all_distinct,
                                         ranges_algo_detail::all_distinct_impl,
                                         std::ranges::equal_to,
                                         export [[deprecated("This algorithm is inefficient and will be removed. Manually construct a set, or use "
...
namespace dice::template_library {
     ...
     * @param proj projection
     */
	export inline constexpr ranges_algo_detail::is_sorted_unique_fn is_sorted_unique;
     ...
     * @return lexicographical three-way compare result of the two ranges
     */
    export inline constexpr ranges_algo_detail::lexicographical_compare_three_way_fn lexicographical_compare_three_way;
