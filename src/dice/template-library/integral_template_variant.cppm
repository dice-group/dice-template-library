...
export module dice.template_library:integral_template_variant;
...
namespace dice::template_library {
	 ...
	 */
	export template<std::integral auto first, decltype(first) last, template<decltype(first)> typename T>
