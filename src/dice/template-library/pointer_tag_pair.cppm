...
export module dice.template_library:pointer_tag_pair;
...
namespace dice::template_library {
    ...
    export template<detail_pointer_tag_pair::taggable_pointee T,
    ...
    export template<size_t I, typename T, typename Tag, unsigned BitsRequested>
