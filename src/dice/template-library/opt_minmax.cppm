...
export module dice.template_library:opt_minmax;
...
namespace dice::template_library
{
     ...
     */
    DTL_DEFINE_SINGLE_FUNC_BASED_RANGE_ALGO(opt_min_element, detail_opt_min_max::opt_min_element_impl, std::ranges::less, export);

    /**
     * @return the minimum of the given arguments, treating std::nullopt as "no value".
     */
    export template<typename T, typename Cmp = std::less<T>>
     ...
     */
    DTL_DEFINE_SINGLE_FUNC_BASED_RANGE_ALGO(opt_max_element, detail_opt_min_max::opt_max_element_impl, std::ranges::less, export);
     ...
     */
    DTL_DEFINE_SINGLE_FUNC_BASED_RANGE_ALGO(opt_minmax_element, detail_opt_min_max::opt_minmax_element_impl, std::ranges::less, export);
