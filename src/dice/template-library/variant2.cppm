...
export module dice.template_library:variant2;
...
namespace dice::template_library {
    ...
    export template<typename X, typename T, typename U>
    ...
    export template<size_t ix, typename T, typename U>
    ...
    // overloads for visit
    export template<typename F, typename T, typename U>
...
export template<typename T, typename U> requires (std::formattable<T, char> && std::formattable<U, char>)
