...
export module dice.template_library:limit_allocator;
...
namespace dice::template_library {
	 ...
	 */
	export enum struct limit_allocator_syncness : bool {
	 ...
	 */
	export template<typename T, template<typename> typename Allocator = std::allocator, limit_allocator_syncness syncness = limit_allocator_syncness::sync>
