...
namespace dice::template_library
{
    TEST_SUITE("opt_minmax")
    {
        ...
        TEST_CASE("opt_min with custom comparator")
        {
            ...
            {
                auto result = opt_min(std::greater{}, 5, 3, 8, 1, 4);
                REQUIRE(result.has_value());
                CHECK(*result == 8);
            }
            ...
            {
                auto result = opt_min([](int a, int b) { return a > b; }, 5, 3, 8);
                REQUIRE(result.has_value());
                CHECK(*result == 8);
            }
            ...
            {
                auto result = opt_min(std::greater{}, 10, std::optional{3}, std::nullopt);
                REQUIRE(result.has_value());
                CHECK(*result == 10);
            }
            ...
            {
                auto result = opt_min<double>(std::greater{}, 5, 3, 8);
                CHECK(std::same_as<decltype(result), std::optional<double>>);
                REQUIRE(result.has_value());
                CHECK(*result == 8.0);
            }
            ...
            {
                std::vector<int> v{5, 3, 8, 1, 4};
                auto result = opt_min_range(v, std::greater{});
                REQUIRE(result.has_value());
                CHECK(*result == 8);
            }
        ...
        TEST_CASE("opt_max with custom comparator")
        {
            SUBCASE("variadic with std::greater reverses order")
            {
                auto result = opt_max(std::greater{}, 5, 3, 8, 1, 4);
                REQUIRE(result.has_value());
                CHECK(*result == 1);
            }
            ...
            SUBCASE("variadic with mixed args and comp")
            {
                auto result = opt_max(std::greater{}, 10, std::optional{3}, std::nullopt);
                REQUIRE(result.has_value());
                CHECK(*result == 3);
            }
            ...
            SUBCASE("variadic typed with comp")
            {
                auto result = opt_max<double>(std::greater{}, 5, 3, 8);
                CHECK(std::same_as<decltype(result), std::optional<double>>);
                REQUIRE(result.has_value());
                CHECK(*result == 3.0);
            }
            ...
            {
                std::vector<int> v{5, 3, 8, 1, 4};
                auto result = opt_max_range(v, std::greater{});
                REQUIRE(result.has_value());
                CHECK(*result == 1);
            }
        }
        ...
        TEST_CASE("opt_minmax with custom comparator")
        {
            SUBCASE("variadic with std::greater reverses order")
            {
                auto result = opt_minmax(std::greater{}, 5, 3, 8, 1, 4);
                REQUIRE(result.min.has_value());
                REQUIRE(result.max.has_value());
                CHECK(*result.min == 8);
                CHECK(*result.max == 1);
            ...
            SUBCASE("variadic typed with comp")
            {
                auto result = opt_minmax<double>(std::greater{}, 5, 3, 8);
                CHECK(std::same_as<decltype(result), opt_minmax_result<double>>);
                REQUIRE(result.min.has_value());
                REQUIRE(result.max.has_value());
            ...
            {
                std::vector<int> v{5, 3, 8, 1, 4};
                auto result = opt_minmax_range(v, std::greater{});
                REQUIRE(result.min.has_value());
                REQUIRE(result.max.has_value());
                CHECK(*result.min == 8);
                CHECK(*result.max == 1);
